"""
实验 A：冻结 ViT Backbone
目标：减少资源占用，尝试提升验证集准确率
"""
...
model_name = f"vit_expA_{config['version']}.pt"
log_path = f"logs/vit_expA_log_{config['version']}.csv"
plot_path = f"plots/vit_expA_plot_{config['version']}.png"
