...
def create_config():
    # create a configuration block, which contain all the flexible default parameters
    parser = argparse.ArgumentParser()
    parser.add_argument('-d', '--dataset_dir', default='F:/RAVDESS_original/Audio_Speech_Actors_01-24')
    ...
    parser.add_argument('-r', '--random_state', default=42, type=int)
